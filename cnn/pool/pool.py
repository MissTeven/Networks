...
class Pool(CalcOperator):
    def __init__(self, filter_shape, pad=0):
        super().__init__()
        self.filter_shape = filter_shape
        self.pad = pad

        self.input = None
        self.pool_before_col = None
        self.output = None
    ...
    def onForward(self, input_data):
        ...
        self.pool_before_col = col
        col = col.reshape((N, out_h, out_w, C, self.filter_shape[0], self.filter_shape[1])) \
            .transpose((0, 3, 1, 2, 4, 5)) \
            .reshape((N * C * out_h * out_w, self.filter_shape[0] * self.filter_shape[1]))
